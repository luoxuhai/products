...
export const ui = {
  'zh-cn': {
    ...
    maintenanceValue: '持续迭代',
    maintenanceLabel: '长期维护',
  ...
  'zh-tw': {
    ...
    maintenanceValue: '持續迭代',
    maintenanceLabel: '長期維護',
    appsEyebrow: 'All Apps',
    appsTitle: '全部作品',
  ...
  en: {
    ...
    maintenanceValue: 'Continuous',
    maintenanceLabel: 'Long-term maintenance',
    appsEyebrow: 'All Apps',
    appsTitle: 'All apps',
  ...
  ja: {
    ...
    maintenanceValue: '継続改善',
    maintenanceLabel: '長期メンテナンス',
    appsEyebrow: 'All Apps',
    appsTitle: 'すべての作品',
