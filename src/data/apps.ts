...
export const ui = {
  'zh-cn': {
    ...
    heroIntroExperienceSuffix: ' 年独立开发经验，用设计与技术打磨细节，持续创造简洁、实用、可靠的 App。',
    viewApps: '查看 App',
    ...
    appCount: '款 App',
    categoryCount: '个方向',
    mobileFirstValue: 'Universal',
    mobileFirstLabel: '多设备体验',
  ...
  'zh-tw': {
    ...
    heroIntroExperienceSuffix: ' 年獨立開發經驗，用設計與技術打磨細節，持續創造簡潔、實用、可靠的 App。',
    viewApps: '查看 App',
  ...
  en: {
    ...
    heroIntroExperienceSuffix: ' years of independent development experience, refining details with design and technology to keep creating simple, practical, and reliable apps.',
    viewApps: 'View apps',
    ...
    mobileFirstValue: 'Universal',
    mobileFirstLabel: 'Multi-device experience',
    appsEyebrow: 'All Apps',
    appsTitle: 'All apps',
  ...
  ja: {
    ...
    heroIntroExperienceSuffix: '年の個人開発経験。デザインと技術で細部を磨き、シンプルで実用的、信頼できる App を作り続けています。',
    viewApps: 'App を見る',
