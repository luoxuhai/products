...
export const ui = {
  'zh-cn': {
    ...
    phoneModelLabel: 'iPhone 15 Pro 外观模型',
    newestRelease: '最新发布',
    overviewLabel: '作品概览',
    appCount: '款 App',
    categoryCount: '个方向',
    mobileFirstValue: 'iPhone',
    mobileFirstLabel: '移动优先',
    ...
    contactTitle: '想了解更多？',
    contactText: '欢迎通过邮件反馈 App 体验，或在 App Store 查看完整开发者页面。',
    email: '发送邮件',
  ...
  'zh-tw': {
    ...
    phoneModelLabel: 'iPhone 15 Pro 外觀模型',
    newestRelease: '最新發布',
    overviewLabel: '作品概覽',
    appCount: '款 App',
    categoryCount: '個方向',
    mobileFirstValue: 'iPhone',
    mobileFirstLabel: '行動優先',
    appsEyebrow: 'All Apps',
    appsTitle: '全部作品',
    ...
    contactEyebrow: 'Contact',
    contactTitle: '想了解更多？',
    contactText: '歡迎透過電子郵件回饋 App 體驗，或在 App Store 查看完整開發者頁面。',
    email: '發送郵件',
  ...
  en: {
    ...
    phoneModelLabel: 'iPhone 15 Pro visual model',
    newestRelease: 'Latest release',
    overviewLabel: 'Portfolio overview',
    appCount: 'apps',
    categoryCount: 'categories',
    mobileFirstValue: 'iPhone',
    mobileFirstLabel: 'Mobile first',
    appsEyebrow: 'All Apps',
    appsTitle: 'All apps',
    ...
    contactText: 'Send feedback by email, or visit the complete developer profile on the App Store.',
    email: 'Send email',
  ...
  ja: {
    ...
    phoneModelLabel: 'iPhone 15 Pro 外観モデル',
    newestRelease: '最新リリース',
    overviewLabel: '作品概要',
    appCount: '個の App',
    categoryCount: '分野',
    mobileFirstValue: 'iPhone',
    mobileFirstLabel: 'モバイル優先',
    appsEyebrow: 'All Apps',
    appsTitle: 'すべての作品',
    ...
    contactEyebrow: 'Contact',
    contactTitle: 'もっと詳しく知りたいですか？',
    contactText: 'App の体験についてメールでフィードバックするか、App Store の開発者ページをご覧ください。',
    email: 'メールを送信',
